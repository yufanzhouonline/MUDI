...
class scHiC(HiC):
    ...
    def cellLabel(self, labelPath = 'scHicLabenName.txt'):
        '''
    ...
    def cellCluster(self, clusterPath = 'clusterList.txt'):
        '''
    ...
    def commonBinNum(self, hicProPath = '/data/singleCells/hicpro/output/hic_results/matrix/', sampleName, clusterList, res=1000000):
        '''
    ...
    def commonBinSet(self, hicProPath = '/data/singleCells/hicpro/output/hic_results/matrix/', sampleName, clusterList, res=1000000):
        '''
        The set of CADs.
        '''
        groupName = sampleName[sampleName.Name.isin(clusterList)].copy()
    ...
    def cadScore(self, hicProPath = '/data/singleCells/hicpro/output/hic_results/matrix/', sampleName, clusterList, res=1000000):
        '''
    ...
    def cadsLoci(self, bedDf, scoreDf):
        ...
        scoreDf = scoreDf[scoreDf.bin1.isin(binList) & scoreDf.bin2.isin(binL   ist)].copy()
    ...
    def clusterGeneList(self):
        ...
        for i in range(len(self.clusterList)):
            self.cadScore(self.sampleName, self.clusterList[i])
    ...
    def commonBin(self, sampleName, clusterList, clusterNo, res=1000000):
        '''
        ...
        '''
        commonSet = self.commonBinSet(sampleName, clusterList[clusterNo], res=res)
        ###loci of CADs
    ...
    def cellShift(self, scTadPath = '/data/insulation', batch1TadPath = '/data/insulation/mcf7/', batch2TadPath = '/data/insulation/mcf7m1/', batch3TadPath = '/data/insulation/mcf7tr/', sampleName, pdCluster, clusterNo, commonBin, res=100000, cads=True):
        '''
